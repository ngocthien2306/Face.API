...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--file_name", help="video file name", default='pexels_videos_1721303.mp4', type=str)
    ...
    parser.add_argument('-net', '--network', help="network", default='mbf')
...
#     output_path = str(conf.facebank_path / '{}.mp4'.format(args.save_name))
#
#     # Define the FourCC code for the video codec (e.g., 'mp4v', 'avc1', 'X264')
#     fourcc = cv2.VideoWriter_fourcc(*'X264')
#
#     # Define the video dimensions (width, height)
#     video_size = (1280, 720)
#
